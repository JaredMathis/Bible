...
import string_letters_only from '../foundation/string_letters_only.js';
...
import html_input from '../ui/html_input.js';
import ui_labelled_input from '../ui/ui_labelled_input.js';
import html_element_with_classes from '../ui/html_element_with_classes.js';
...
async function ui_bible_root(parent, data, bible) {
  ...
  let container_verses = ui_list(parent, data, 'verses', (list_item, bible_verse, index) => {
    ...
    for_each(data_interlinear_verse, interlinear_word => {
      ...
      let languages = {'h':'hebrew','g':'greek'};
  ...
  let { container:container_books, input:input_books } = ui_list_action_string(parent, data, 'books', 'book', 'Choose a book of the Bible');
  let { container:container_chapters, input:input_chapters } = ui_list_action_string(parent, data, 'chapters', 'chapter', 'Choose a chapter');
  let elements = [container_verses, title, container_books, container_chapters];
